...
export default function Department6({ data }) {
                    ...
                    <div className="col-xl-4 col-md-6" key={index}>
                        <div className="cs_iconbox cs_style_7">
                            ...
                            {item.department_title && (
                                <h2
                                    className="cs_iconbox_title cs_fs_32"
                                    dangerouslySetInnerHTML={{
                            ...
                            {item.department_btn_url && (
                                <NavigationLink href={item.department_btn_url} className="cs_iconbox_btn cs_center">
                                    <svg
                                        width={35}
                                        height={24}
                                        viewBox="0 0 35 24"
