...
export default function Map1({ data }) {
    const { google_map_iframe, section_title, section_subtitle, is_show_contact_info } = data
                            ...
                            <div className="col-xl-4">
                                <div className="cs_iconbox cs_style_11 cs_radius_25">
                                    ...
                                    <div className="cs_iconbox_right">
                                        <h3 className="cs_iconbox_title cs_fs_24 mb-0">{translate("Phone")}</h3>
                        ...
                        {customize?.contact?.contact_email && (
                            <div className="col-xl-4">
                                <div className="cs_iconbox cs_style_11 cs_radius_25">
                                    ...
                                    <div className="cs_iconbox_right">
                                        <h3 className="cs_iconbox_title cs_fs_24 mb-0">{translate("Email")}</h3>
                                        <p className="cs_iconbox_subtitle mb-0 cs_heading_color">
                                            {customize?.contact?.contact_email}
                                        </p>
                                    </div>
                        ...
                        {customize?.contact?.contact_address && (
                            <div className="col-xl-4">
                                <div className="cs_iconbox cs_style_11 cs_radius_25">
                                    ...
                                    <div className="cs_iconbox_right">
                                        <h3 className="cs_iconbox_title cs_fs_24 mb-0">{translate("Location")}</h3>
                                        <p
