...
export default function AppointmentWithFormBuilder3({ sections_data }) {
    ...
    return (
        <div className="container">
            <form ref={formRef} className="cs_appointment_form cs_style_1" onSubmit={handleSubmit}>
                <div className="cs_appointment_form_head">
                    {sections_data.section_title && (
                        <>
                            <h2
                                className="cs_fs_40 mb-0"
                                ...
                                {form.fieldType === "radio" ? (
                                    <>
                                        ...
                                        {form?.radio_options?.map((option, i) => {
                                            ...
                                            return (
                                                <div key={i} className="cs_appointment_category">
                                                    <input
                                                        type="radio"
                                                        name={`radio_${index}`}
                                                        id={`radio_${index}_${i}`}
                                                        ...
                                                        checked={
                                                            ...
                                                            (!radioSelections[fieldName] && option === form.radio_default_checked)
                                                        }
                                                        onChange={(e) => {
                                                    ...
                                                    />
                                                    <span htmlFor={`radio_${index}_${i}`}>{option}</span>
                                                </div>
                                            )
                                        })}
                                    </>
                                            ...
                                            {form?.checkbox_options?.map((option, i) => {
                                                ...
                                                return (
                                                    <div key={i} className="cs_checkbox_wrap">
                                                        ...
                                                        />
                                                        <label className="cs_checkbox_label" htmlFor={`checkbox_${index}_${i}`}>
                                                            {option}
                                                        </label>
                                                    </div>
                                                )
                ...
                {wasSuccessful && (
                    <div className="text-success text-end" style={{ marginTop: "30px" }}>
                        {flash.success}
                    </div>
                )}
            </form>
