    ...
    return (
        <AuthLayout>
            <div className="cs_card_card_in">
                ...
                <h1 className="cs_card_title cs_mb_30">{translate("Recover your password")}!</h1>
                {flash.error && <div className="alert alert-danger">{flash.error}</div>}
                <p>
                    {translate(
                        "We received a request to reset your password. Please enter the email address associated with your account, and we'll send you a link to reset your password. Simply click the link and follow the instructions to set a new password."
                    )}
                </p>
                <form onSubmit={handleForgetPass} className="">
                    ...
                    <div>
                        <button type="submit" disabled={processing} className="cs_btn cs_style_1 w-100">
