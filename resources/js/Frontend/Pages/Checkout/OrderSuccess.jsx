...
export default function OrderSuccess({ order, meta_tags, tagline, site_name }) {
    ...
    return (
        <FrontendLayout>
            <PageHeading data={pageHeaderData} bgSrc={"/static/page_heading.svg"} />
                    ...
                    <div className="col-md-6">
                        <div className="card booking-card p-4">
                            <div className="card-body">
                                ...
                                <h1 className="cs_fs_48">{translate("Your Order Has Been Successfully Placed")}!</h1>
                                <p className=" cs_accent_color">
                                    {translate("Your order id is")}: #{order.order_number}
                                </p>
                                <Link href={route("home")} className="cs_btn cs_style_1 cs_type_3">
                                    <span>{translate("Go to Homepage")}</span>
                                    <i>
                                        <svg
                                            width="35"
                                            height="24"
