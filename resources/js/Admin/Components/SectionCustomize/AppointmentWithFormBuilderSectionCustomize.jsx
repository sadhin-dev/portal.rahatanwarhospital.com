...
export default function AppointmentWithFormBuilderSectionCustomize({ index }) {
                                ...
                                {["1", "2", "3", "4"].map((value) => (
                                    <div key={value} className="cs_section_image" onClick={() => setLayout(!layout)}>
                                        ...
                                        <div className="cs_section_image_in">
                                            <img src={`/static/sections/appointment/style_${value}.jpg`} alt="Thumb" />
                                                            ...
                                                            onChange={(e) =>
                                                                setData(
                                                                    produce((draft) => {
                                                                        ...
                                                                        // Clear default option if it's no longer in the options list
                                                                        if (
