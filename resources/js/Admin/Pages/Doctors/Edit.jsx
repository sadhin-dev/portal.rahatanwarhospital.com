...
import DoctorDetails from "@/Admin/Components/SectionCustomize/DoctorDetails"
...
export default function Edit({ default_lang, sections, doctor, currentLang }) {
    const { pageData, pageInfo, clickedSection } = useSelector((state) => state.pages)
    ...
    const [expandCustomize, setExpandCustomize] = useState("DoctorDetailsPage")
    ...
    const handleUpdate = () => {
        ...
        if (!errors) {
            router.put(route("admin.doctors.update", doctor), {
                pageData,
                pageInfo,
                customizeSections
            })
    ...
    switch (expandCustomize) {
        case "DoctorDetailsPage":
            customizeSection = <DoctorDetails />
            break
        case "Hero":
    ...
    return (
        <PageCustomizeLayout type="doctor">
            <Head title="Edit Doctor" />
            <div className="customize-header-actions">
                <Link href={route("admin.doctors.index")} className="dismiss">
            ...
            <div className="customize-section-wrap">
                ...
                <div className="customize-section-area">
                    ...
                    <div className="customize-sections">
                        <div className="customize-sections-item" onClick={() => handleExpand("DoctorDetailsPage")}>
