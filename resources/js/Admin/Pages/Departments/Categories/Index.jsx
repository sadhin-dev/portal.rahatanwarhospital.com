...
import { search, shieldOutline } from "ionicons/icons"
...
export default function Index({ categories, sort, filtered_lang, languages }) {
    ...
    const getResults = (search, lang) => {
        router.get(
            route("admin.departments.categories.index", {
    ...
    const handleBulkAction = () => {
        ...
        if (selectedOption === "Delete") {
            ...
            action = "admin.departments.categories.bulk.delete"
        }
        setIsMarkAll([])
                                ...
                                <div className="yooDataTableWrap">
                                    <div className="dataTables_heading">
                                        ...
                                        <div className="dataTables_heading_right">
                                            ...
                                            {hasPermission("department_categories.create") && (
                                                <Link
                                                    href={route("admin.departments.categories.create")}
                                                ...
                                                {categories.data.map((category, index) => (
                                                    <tr className="odd" key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                {hasPermission("department_categories.edit") && (
                                                                    <Link
                                                                        href={route(
                                                                            "admin.departments.categories.edit",
                                                                            category
                                                                        )}
                                                                ...
                                                                {hasPermission("department_categories.delete") && (
                                                                    <DeleteButton
                                                                        href={route(
                                                                            "admin.departments.categories.destroy",
                                                                            category
                                                                        )}
                                                                    />
                                                                )}
